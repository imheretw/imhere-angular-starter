System.config({
  ...
  map: {
    ...
    "npm:algoliasearch@3.20.4": {
      "agentkeepalive": "npm:agentkeepalive@2.2.0",
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      "crypto": "github:jspm/nodelibs-crypto@0.1.0",
      "debug": "npm:debug@2.6.0",
      "envify": "npm:envify@4.0.0",
      ...
      "tap-bail": "npm:tap-bail@0.0.0",
      "tap-dot": "npm:tap-dot@1.0.5",
    ...
    "npm:autoprefixer@6.7.6": {
      ...
      "caniuse-db": "npm:caniuse-db@1.0.30000632",
    ...
    "npm:tap-bail@0.0.0": {
      "child_process": "github:jspm/nodelibs-child_process@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "tap-parser": "npm:tap-parser@0.4.3"
    },
    "npm:tap-dot@1.0.5": {
      "chalk": "npm:chalk@1.1.3",
      "tap-out": "npm:tap-out@1.4.2",
      "through2": "npm:through2@2.0.3"
    },
    "npm:tap-out@1.4.2": {
      "events": "github:jspm/nodelibs-events@0.1.1",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "re-emitter": "npm:re-emitter@1.1.3",
      "readable-stream": "npm:readable-stream@2.2.2",
      "split": "npm:split@1.0.0",
      "trim": "npm:trim@0.0.1",
      "util": "github:jspm/nodelibs-util@0.1.0"
    },
    "npm:tap-parser@0.4.3": {
      "inherits": "npm:inherits@2.0.1",
      "readable-stream": "npm:readable-stream@1.1.14"
    },
    "npm:through2@2.0.3": {
